...
public abstract class CharacterEncoder
{
    ...
    public String encode(byte[] paramArrayOfByte)
    {
        ...
        {
            throw new Error("com.example.eps3.myapplication.Login.CharacterEncoder.encode internal error");
        }
        return str;
    }
    ...
    public String encodeBuffer(byte[] paramArrayOfByte)
    {
        ...
        {
            throw new Error("com.example.eps3.myapplication.Login.CharacterEncoder.encodeBuffer internal error");
        }
