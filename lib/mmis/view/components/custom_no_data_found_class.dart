              ...
              children: [
                ...
                Center(
                  ...
                  child: Column(
                    children: [
                      Text(
                        widget.isNoInternet ? 'noInternet'.tr : widget.message,
                        textAlign: TextAlign.center,
                        style: interSemiBoldDefault.copyWith(color: widget.isNoInternet ? MyColor.red : MyColor.getPrimaryTextColor(), fontSize: Dimensions.fontExtraLarge),
                      ),
                      const SizedBox(
                        height: 5,
                      ),
                      widget.isNoInternet
                          ...
                          : Text(
                              widget.message2,
                              style: interRegularDefault.copyWith(color: MyColor.getSecondaryTextColor(), fontSize: Dimensions.fontLarge),
                              textAlign: TextAlign.center,
                            ),
                      widget.isNoInternet
                          ? const SizedBox(
