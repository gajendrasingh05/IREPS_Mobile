class StockCoveredDueDetails {
  String? apiFor;
  String? count;
  String? status;
  String? message;
  List<CoveredDueData>? data;

  StockCoveredDueDetails(
      {this.apiFor, this.count, this.status, this.message, this.data});

  StockCoveredDueDetails.fromJson(Map<String, dynamic> json) {
    apiFor = json['api_for'];
    count = json['count'];
    status = json['status'];
    ...
    if (json['data'] != null) {
      data = <CoveredDueData>[];
      json['data'].forEach((v) {
        data!.add(new CoveredDueData.fromJson(v));
      });
    }
  }
...
class CoveredDueData {
  ...
  CoveredDueData.fromJson(Map<String, dynamic> json) {
    dp = json['dp'];
    poNo = json['po_no'];
    podt = json['podt'];
    pocat = json['pocat'];
