import 'package:flutter_app/udm/utils/my_color.dart';
import 'package:flutter/material.dart';
import 'package:flutter_app/udm/widgets/switch_button/my_switch_widget.dart';
...
class CustomSwitch extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    inactiveColor: MyColor.backgroundColor,
    padding: 4.0,
    showOnOff: false,
    onToggle: onChanged);
  }
