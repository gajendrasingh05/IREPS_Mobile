class CrcSummarylinkData {
  String? apiFor;
  String? count;
  String? status;
  String? message;
  List<CrcsumrylinkData>? data;

  CrcSummarylinkData(
      {this.apiFor, this.count, this.status, this.message, this.data});

  CrcSummarylinkData.fromJson(Map<String, dynamic> json) {
    apiFor = json['api_for'];
    count = json['count'];
    status = json['status'];
    message = json['message'];
    if (json['data'] != null) {
      data = <CrcsumrylinkData>[];
      json['data'].forEach((v) {
        data!.add(new CrcsumrylinkData.fromJson(v));
      });
    }
  }
...
class CrcsumrylinkData {
  ...
  CrcsumrylinkData.fromJson(Map<String, dynamic> json) {
