class WarrantyrejectionreportData {
  String? apiFor;
  String? count;
  String? status;
  String? message;
  List<WarrantyrejrepData>? data;

  WarrantyrejectionreportData(
      {this.apiFor, this.count, this.status, this.message, this.data});

  WarrantyrejectionreportData.fromJson(Map<String, dynamic> json) {
    apiFor = json['api_for'];
    count = json['count'];
    status = json['status'];
    message = json['message'];
    if (json['data'] != null) {
      data = <WarrantyrejrepData>[];
      json['data'].forEach((v) {
        data!.add(new WarrantyrejrepData.fromJson(v));
      });
    }
  }
...
class WarrantyrejrepData {
  ...
  WarrantyrejrepData.fromJson(Map<String, dynamic> json) {
