class CrcAwaitingData {
  String? apiFor;
  String? count;
  String? status;
  String? message;
  List<CrcAwaitData>? data;

  CrcAwaitingData(
      {this.apiFor, this.count, this.status, this.message, this.data});

  CrcAwaitingData.fromJson(Map<String, dynamic> json) {
    apiFor = json['api_for'];
    count = json['count'];
    status = json['status'];
    ...
    if (json['data'] != null) {
      data = <CrcAwaitData>[];
      json['data'].forEach((v) {
        data!.add(CrcAwaitData.fromJson(v));
      });
    }
  }
...
class CrcAwaitData {
  ...
  CrcAwaitData.fromJson(Map<String, dynamic> json) {
