class CrcfinalzedData {
  String? apiFor;
  String? count;
  String? status;
  String? message;
  List<CrcfinalzData>? data;

  CrcfinalzedData(
      {this.apiFor, this.count, this.status, this.message, this.data});

  CrcfinalzedData.fromJson(Map<String, dynamic> json) {
    apiFor = json['api_for'];
    count = json['count'];
    status = json['status'];
    ...
    if (json['data'] != null) {
      data = <CrcfinalzData>[];
      json['data'].forEach((v) {
        data!.add(CrcfinalzData.fromJson(v));
      });
    }
  }
...
class CrcfinalzData {
  ...
  CrcfinalzData.fromJson(Map<String, dynamic> json) {
