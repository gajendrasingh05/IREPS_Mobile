class CrnMyfinalisedData {
  String? apiFor;
  String? count;
  String? status;
  String? message;
  List<MyfinalisedCrnData>? data;

  CrnMyfinalisedData(
      {this.apiFor, this.count, this.status, this.message, this.data});

  CrnMyfinalisedData.fromJson(Map<String, dynamic> json) {
    apiFor = json['api_for'];
    count = json['count'];
    status = json['status'];
    message = json['message'];
    if (json['data'] != null) {
      data = <MyfinalisedCrnData>[];
      json['data'].forEach((v) {
        data!.add(new MyfinalisedCrnData.fromJson(v));
      });
    }
  }
...
class MyfinalisedCrnData {
  ...
  MyfinalisedCrnData.fromJson(Map<String, dynamic> json) {
