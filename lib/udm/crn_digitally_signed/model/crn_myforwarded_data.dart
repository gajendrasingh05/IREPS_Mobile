class CrnMyforwardedData {
  String? apiFor;
  String? count;
  String? status;
  String? message;
  List<MyforwardedCrnData>? data;

  CrnMyforwardedData(
      {this.apiFor, this.count, this.status, this.message, this.data});

  CrnMyforwardedData.fromJson(Map<String, dynamic> json) {
    apiFor = json['api_for'];
    count = json['count'];
    status = json['status'];
    message = json['message'];
    if (json['data'] != null) {
      data = <MyforwardedCrnData>[];
      json['data'].forEach((v) {
        data!.add(MyforwardedCrnData.fromJson(v));
      });
    }
  }
...
class MyforwardedCrnData {
  ...
  MyforwardedCrnData.fromJson(Map<String, dynamic> json) {
