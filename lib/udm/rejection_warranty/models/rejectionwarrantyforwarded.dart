class RejectionWarrantyforwarded {
  String? apiFor;
  String? count;
  String? status;
  String? message;
  List<WarrantyforwardedData>? data;

  RejectionWarrantyforwarded(
      {this.apiFor, this.count, this.status, this.message, this.data});

  RejectionWarrantyforwarded.fromJson(Map<String, dynamic> json) {
    apiFor = json['api_for'];
    count = json['count'];
    status = json['status'];
    message = json['message'];
    if (json['data'] != null) {
      data = <WarrantyforwardedData>[];
      json['data'].forEach((v) {
        data!.add(new WarrantyforwardedData.fromJson(v));
      });
    }
  }
...
class WarrantyforwardedData {
  ...
  WarrantyforwardedData.fromJson(Map<String, dynamic> json) {
    fwddetails = json['fwddetails'];
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['fwddetails'] = this.fwddetails;
